...
ZEND_BEGIN_ARG_INFO_EX(arginfo_saxonproc_construct, 0, 0, 1)
...
ZEND_BEGIN_ARG_INFO_EX(arginfo_saxonc_xe_setInitialTemplateParameters, 0, 0, 2)
...
ZEND_BEGIN_ARG_INFO_EX(arginfo_saxonc_xp_compileFromFile, 0, 0, 2)
ZEND_ARG_INFO(0, source_file_name)
ZEND_ARG_INFO(0, stylesheet_file_name)
ZEND_END_ARG_INFO()
...
ZEND_BEGIN_ARG_INFO_EX(arginfo_saxonc_xdmval_toString, 0, 0, 0)
ZEND_END_ARG_INFO()
...
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(arginfo_saxonc_xdmitem_toString, 0, 0, 0)
ZEND_END_ARG_INFO()
...
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(arginfo_saxonc_xdmfunc_toString, 0, 0, 0)
ZEND_END_ARG_INFO()
...
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(arginfo_saxonc_xdmnode_toString, 0, 0, 0)
ZEND_END_ARG_INFO()
...
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(arginfo_saxonc_xdmatomic_toString, 0, 0, 0)
ZEND_END_ARG_INFO()
...
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(arginfo_saxonc_xdmmap_toString, 0, 0, 0)
ZEND_END_ARG_INFO()
...
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(arginfo_saxonc_xdmarray_toString, 0, 0, 0)
ZEND_END_ARG_INFO()
