...
PHP_METHOD(SaxonProcessor, setCatalog) {
  ...
  if (zend_parse_parameters(ZEND_NUM_ARGS(), "sb", &catalogFile, &len) ==
      FAILURE) {
    RETURN_NULL();
  }
    ...
    if (object_init_ex(return_value, xdmNode_ce) != SUCCESS) {
      ...
      if (indexi >= 0 && indexi < count) {
        ...
        if (childNode != nullptr) {
          // std::cerr<<"getChildNode i="<<indexi<<"
          // Kind="<<childNode->getNodeKind()<<"
          // pointer="<<(childNode)<<std::endl; std::cerr<<"getChildNode
          // str="<<(childNode->getStringValue())<<std::endl;
  ...
  if (xdmNode != nullptr) {
    ...
    if (object_init_ex(return_value, xdmNode_ce) != SUCCESS) {
      ...
      if (axisValue > 0) {
        ...
        XdmNode ** nodes = xdmNode->axisNodes(xdmNode->convertEnumXdmAxis(axisValue));
                ...
                PHP_ME(SaxonProcessor, setcwd, arginfo_saxonc_setcwd,
                    ...
                    PHP_ME(
                        ...
                        PHP_ME(SaxonProcessor, newXQueryProcessor,
                               ...
                               ZEND_ACC_PUBLIC)
                            PHP_ME(SaxonProcessor, newSchemaValidator,
                                   arginfo_saxonc_newSchemaValidator,
                                   ZEND_ACC_PUBLIC)
                                PHP_ME(SaxonProcessor, setCatalog,
...
zend_function_entry xdmNode_methods[] = {
 ...
 PHP_ME(XdmNode, axisNodes, arginfo_saxonc_xdmnode_axisNodes,
                        ZEND_ACC_PUBLIC)
                        ...
                        PHP_ME(
                            ...
                            PHP_ME(XdmNode, getParent,
                                   ...
                                   ZEND_ACC_PUBLIC)
                                PHP_ME(XdmNode, getAttributeNode,
                                    ...
                                    PHP_ME(
                                        ...
                                        PHP_ME(
                                            ...
                                            ZEND_ACC_PUBLIC){nullptr, nullptr,
                                                             nullptr}};
...
PHP_MINFO_FUNCTION(saxon) {
  ...
  php_info_print_table_row(2, "SaxonC API version", "12.3");
