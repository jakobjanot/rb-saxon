...
if system() == 'Darwin':
    ...
    extra_link_args.append('libs\\win\\libsaxon-hec-12.3.lib')
else:
...
ext_modules = [Extension(
                       ...
                       libraries=['../libs/nix/saxon-hec-12.3']
                        ),
                ]
setup(
    name='saxonche',
    version='12.3.0',
    description='Official Saxonica python package for the SaxonC-HE 12.3 processor: for XSLT 3.0, XQuery 3.1, XPath 3.1 and XML Schema processing.',
